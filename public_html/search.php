            ...
            <div>
                ...
                <div class="searchtable2">
                    ...
                    <ul>
                            ...
                            <li><p><a href="searchcustomer#searchcustomer" class="main-header">Search Customer Purchase History </a></p></li>
                            <li><p><a href="searchseller.php#searchseller" class="main-header">Search Sellers by Category</a></p></li>  
                    </ul>
                    </div>
                </div>
            </div>
